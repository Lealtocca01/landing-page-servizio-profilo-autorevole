  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-slate-950 via-blue-950 to-blue-950">
      ...
      <div className="container-custom relative z-10 px-8 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[70vh] lg:min-h-[80vh]">
          ...
          >
            <motion.h1
              className="text-5xl sm:text-6xl md:text-6xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black text-white mb-4 lg:mb-6 leading-tight"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <span className="text-5xl sm:text-6xl md:text-6xl lg:text-5xl xl:text-6xl 2xl:text-7xl">Sei un <span className="text-gradient">professionista</span> nel tuo settore?</span>{' '}
              <span className="text-4xl sm:text-5xl md:text-5xl lg:text-4xl xl:text-5xl 2xl:text-6xl">Nel <span className="text-gradient">2025</span> non puoi non essere su{' '}
              <span className="text-gradient">LinkedIn</span>!</span>
            </motion.h1>

            <motion.div
              className="text-xl sm:text-2xl md:text-2xl lg:text-xl xl:text-2xl text-gray-300 mb-6 lg:mb-8 leading-relaxed max-w-4xl"
          ...
          <motion.div
            className="w-full lg:flex lg:justify-end mt-2 lg:mt-0"
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
        ...
        {/* CTA Button - Moved after BusinessStatsGraphic */}
        <motion.div
        ...
        >
          <motion.button
            className="btn-primary px-8 sm:px-10 py-4 sm:py-5 rounded-xl font-bold text-white flex items-center space-x-2 text-lg sm:text-xl transform-gpu transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-500 hover:shadow-[0_16px_40px_rgba(59,130,246,0.4)] hover:scale-110"
            whileHover={{ 
              scale: 1.1, 
              rotate: 2,
        ...
        <div className="mt-16 lg:mt-32">
          <motion.div
            ...
            viewport={{ once: true }}
          >
                         <h2 className="text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black text-white mb-4 lg:mb-6">
             <span className="text-white">Sei già in </span><span className="text-gradient">ritardo!</span>
             </h2>
            <p className="text-xl sm:text-2xl md:text-2xl lg:text-xl xl:text-2xl text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
            ...
            <div className="lg:w-1/2">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                  <h3 className="text-3xl sm:text-4xl md:text-4xl lg:text-3xl font-black text-white mb-6">
                  ...
                  <div className="mt-6 text-center lg:text-left">
                    ...
                    <div className="w-64 h-0.5 bg-green-400 rounded-full mx-auto lg:mx-0"></div>
                  </div>
              </motion.div>
            </div>

            {/* Right side - Cards in vertical column - Hidden on mobile */}
