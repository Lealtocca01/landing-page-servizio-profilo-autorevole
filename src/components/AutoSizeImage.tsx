...
export default function AutoSizeImage({
  ...
  const imageStyle = {
    opacity: loaded ? 1 : 0,
    transition: enableLazyLoading ? 'opacity 0.3s ease-in' : 'none', // Ridotto da 0.5s a 0.3s per performance
    transform: 'translateZ(0)',
    backfaceVisibility: 'hidden' as const,
    willChange: 'opacity' // Ottimizzazione per GPU
  };
          ...
          {link ? (
            ...
            >
              <NextImage
                ...
                alt="Auto size image"
                fill
                quality={85} // Qualità ottimizzata per performance
