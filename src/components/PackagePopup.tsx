              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div>
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-neutral-900 placeholder-gray-400 focus:outline-none focus:ring-1 transition-colors resize-none ${
